...
@Composable
fun Authors(viewModel: AuthorsViewModel) {
    Scaffold(
        ...
        Box(
            ...
            Column(
                ...
                val authors by viewModel.authorsFlow.collectAsState()
                Row(
                    verticalAlignment = Alignment.CenterVertically,
                    modifier = Modifier.padding(10.dp)
                ) {
                    OutlinedTextField(value = searchString,
                        onValueChange = { viewModel.handleIntent(AuthorsViewModel.Intent.Search(it)) },
